...
const Contact = () => {
    return (
        <SectionWrapper id="contact" className="py-24 bg-slate-900/10 relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto relative">
                ...
                <motion.div
                    ...
                    className="space-y-8"
                >
                    <div className="glass p-8 rounded-3xl relative overflow-hidden group shadow-md border-slate-800">

                        <h3 className="text-2xl font-semibold text-slate-100 mb-6 font-heading">Contact Information</h3>

                        <div className="space-y-6">
                            <a href="mailto:imdineshbdr@gmail.com" className="flex items-center gap-4 text-slate-300 hover:text-white transition-colors group/link p-4 rounded-xl hover:bg-slate-800/50 border border-transparent hover:border-slate-700">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg">imdineshbdr@gmail.com</p>
                                </div>
                            </a>
                        ...
                        <h3 className="text-xl font-semibold text-slate-100 mt-10 mb-6 border-b border-slate-700/50 pb-4 font-heading">Social Profiles</h3>

                        <div className="flex gap-4">
                            <a href="https://github.com/DineshBahadurShahi" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-xl bg-slate-800/80 border border-slate-700 hover:border-slate-500 flex items-center justify-center text-slate-400 hover:text-white transition-all duration-300 hover:-translate-y-1 shadow-lg group/social hover:shadow-[0_0_15px_rgba(99,102,241,0.3)]">
                                <SiGithub className="text-xl group-hover/social:scale-105 transition-transform" />
                            </a>
                            <a href="https://www.linkedin.com/in/dinesh-bahadur-shahi-24749628a/" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-xl bg-slate-800/80 border border-slate-700 hover:border-cyan-500 flex items-center justify-center text-slate-400 hover:text-cyan-400 transition-all duration-300 hover:-translate-y-1 shadow-lg group/social hover:shadow-[0_0_15px_rgba(6,182,212,0.3)]">
                ...
                >
                    <form className="glass p-8 md:p-10 rounded-3xl space-y-6 relative overflow-hidden h-full flex flex-col justify-between group shadow-md border-slate-800">
                        ...
                        <div className="relative z-10 space-y-6">
                            <div className="relative group/input">
                                <input
                                    type="text"
                                    id="name"
                                    className="w-full bg-slate-800/50 border-b-2 border-slate-700 focus:border-indigo-500 px-4 pt-6 pb-2 outline-none transition-colors text-slate-200 peer placeholder-transparent rounded-t-lg"
                            ...
                            <div className="relative group/input">
                                <input
                                    type="email"
                                    id="email"
                                    className="w-full bg-slate-800/50 border-b-2 border-slate-700 focus:border-cyan-500 px-4 pt-6 pb-2 outline-none transition-colors text-slate-200 peer placeholder-transparent rounded-t-lg"
                            ...
                            <div className="relative group/input flex-1">
                                <textarea
                                    id="message"
                                    rows={4}
                                    className="w-full bg-slate-800/50 border-b-2 border-slate-700 focus:border-purple-500 px-4 pt-6 pb-2 outline-none transition-colors text-slate-200 peer placeholder-transparent rounded-t-lg resize-none min-h-[120px]"
                                    placeholder="Message"
                                    required
                                ></textarea>
                                <label
